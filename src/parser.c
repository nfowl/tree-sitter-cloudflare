...
static const TSFieldMapSlice ts_field_map_slices[PRODUCTION_ID_COUNT] = {
  ...
  [11] = {.index = 36, .length = 5},
  [12] = {.index = 41, .length = 1},
  [13] = {.index = 42, .length = 6},
  [14] = {.index = 48, .length = 2},
  [15] = {.index = 50, .length = 10},
  [16] = {.index = 60, .length = 8},
  [17] = {.index = 68, .length = 5},
  [18] = {.index = 73, .length = 14},
  [19] = {.index = 87, .length = 6},
  [20] = {.index = 93, .length = 6},
  [21] = {.index = 99, .length = 2},
  [22] = {.index = 101, .length = 7},
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ip_range, 3, .production_id = 14),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ip_range, 3, .production_id = 14),
  ...
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ends_with_func, 6, .production_id = 19),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ends_with_func, 6, .production_id = 19),
  ...
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_starts_with_func, 6, .production_id = 19),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_starts_with_func, 6, .production_id = 19),
  ...
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stringlike_field, 4, .production_id = 11),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__stringlike_field, 4, .production_id = 11),
  ...
  [242] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(189),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16),
  [247] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(188),
  [250] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(63),
  [253] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(45),
  [256] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(45),
  [259] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(155),
  [262] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(155),
  [265] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_func_repeat1, 2, .production_id = 16), SHIFT_REPEAT(149),
  ...
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_upper_func, 4, .production_id = 8),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_upper_func, 4, .production_id = 8),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lower_func, 4, .production_id = 8),
  [298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lower_func, 4, .production_id = 8),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_uuid_func, 4, .production_id = 10),
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_uuid_func, 4, .production_id = 10),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regex_replace_func, 8, .production_id = 22),
  [306] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_regex_replace_func, 8, .production_id = 22),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_func, 1),
  [310] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_func, 1),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lookup_func, 5, .production_id = 13),
  [314] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lookup_func, 5, .production_id = 13),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_decode_func, 4, .production_id = 8),
  [318] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_url_decode_func, 4, .production_id = 8),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_remove_bytes_func, 6, .production_id = 21),
  [322] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_remove_bytes_func, 6, .production_id = 21),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_remove_bytes_func, 6, .production_id = 20),
  [326] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_remove_bytes_func, 6, .production_id = 20),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_to_string_func, 4, .production_id = 9),
  [330] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_to_string_func, 4, .production_id = 9),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_func, 6, .production_id = 18),
  [334] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_func, 6, .production_id = 18),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_func, 6, .production_id = 15),
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_func, 6, .production_id = 15),
  ...
  [384] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_func, 4, .production_id = 7),
  [386] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_number_func, 4, .production_id = 7),
  ...
  [462] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__array_lhs, 4, .production_id = 12),
  ...
  [474] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_field_expansion, 5, .production_id = 12),
  ...
  [542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__array_lhs, 4, .production_id = 12),
  ...
  [600] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__array_lhs, 6, .production_id = 17),
